...
class Rqstdeli extends StatefulWidget {
  const Rqstdeli({Key? key}) : super(key: key);

  @override
  State<Rqstdeli> createState() => _RqstdeliState();
}

class _RqstdeliState extends State<Rqstdeli> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("View available delivery boys",style: TextStyle(color: Colors.black),),
